...
dependencies {
    ...
    add("secureTools", platform("com.google.protobuf:protobuf-bom:4.36.1"))
    constraints {
        add("secureTools", "org.apache.commons:commons-lang3:3.18.0")
        add("secureTools", "org.apache.httpcomponents:httpclient:4.5.14")
        add("secureTools", "org.bouncycastle:bcprov-jdk18on:1.84")
        add("secureTools", "org.bouncycastle:bcpkix-jdk18on:1.84")
        add("secureTools", "org.bouncycastle:bcutil-jdk18on:1.84")
    }
